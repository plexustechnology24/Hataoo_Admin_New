...
const Product = () => {
    ...
    const getData = useCallback((page = 1, search = '', status = '') => {
        ...
        axios.get('https://hataoo-backend.onrender.com/api/product/read', { params })
            .then((res) => {
    ...
    const handleDelete = () => {
        axios.delete(`https://hataoo-backend.onrender.com/api/product/delete/${deleteModal.id}`)
            .then((res) => {
    ...
    const handleDeleteSelected = () => {
        setIsDeleting(true);
        axios.post('https://hataoo-backend.onrender.com/api/admin/deleteMultiple', { ids: selectedItems, TypeId: "2" })
            .then(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (id) {
                const res = await axios.patch(`https://hataoo-backend.onrender.com/api/product/update/${id}`, formData);
                toast.success(res.data.message || 'Successfully updated');
            } else {
                await axios.post('https://hataoo-backend.onrender.com/api/product/create', formData);
